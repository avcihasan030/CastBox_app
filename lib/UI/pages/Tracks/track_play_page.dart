...
class PlayTrackPage extends ConsumerStatefulWidget {
  final Tracks tracks;
  final bool isFavorite;
  const PlayTrackPage(this.tracks, this.isFavorite, {super.key});

  @override
  ConsumerState createState() => _PlayTrackPageState();
}

class _PlayTrackPageState extends ConsumerState<PlayTrackPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) => findAppBarColor("images/coverimage.jpeg"),
    );
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              child: ListTile(
                            title: Text(
                              widget.tracks.artists.toString(),
